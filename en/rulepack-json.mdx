...
<Callout type="info">
Pay purchases are a stub today — buying grants access without charging — so the
buy / install flow is testable end to end. Real billing plugs in later without
changing how access is decided.
</Callout>
